...
import "react-toastify/dist/ReactToastify.css"; // Fixed CSS import
...
const Home = () => {
  ...
  useEffect(() => {
    const fetchAllTransactions = async () => {
      if (!cUser?._id) return; // Guard clause for undefined cUser
  ...
  }, [refresh, frequency, endDate, type, startDate, cUser?._id]); // Updated dependency
